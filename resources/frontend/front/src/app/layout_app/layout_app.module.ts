...
import { LayoutNavbarFrontComponent } from './layout-navbar-front/layout-navbar-front.component';
import { Layout1CustomerComponent } from './layout-1-customer/layout-1-customer.component';
import { LayoutSidenavCustomerComponent } from './layout-sidenav-customer/layout-sidenav-customer.component';
...
@NgModule({
  ...
  declarations: [
    ...
    LayoutSidenavCustomerComponent,
    LayoutFooterComponent,
    LayoutFrontComponent,
    LayoutNavbarFrontComponent,
  ],
  providers: [
    LayoutAppService
  ]
