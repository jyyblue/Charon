...
export const countries: Countries [] = [
    ...
    { code: "BR", code3: "BRZ", name: "Brazil", number: "076" },
    ...
    { code: "KP", code3: "PRK", name: "O (the Democratic People's Republic of)", number: "408" },
    { code: "KR", code3: "KOR", name: "O (the Republic of)", number: "410" },
