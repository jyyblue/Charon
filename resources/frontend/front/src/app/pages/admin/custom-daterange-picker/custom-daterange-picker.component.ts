...
@Component({
  selector: 'custom-daterange-picker2', // tslint:disable-line
  template: `
  ...
  providers: [{
    ...
    useExisting: forwardRef(() => CustomDaterangePicker2Component),
    multi: true,
  }]
})
export class CustomDaterangePicker2Component implements ControlValueAccessor {
