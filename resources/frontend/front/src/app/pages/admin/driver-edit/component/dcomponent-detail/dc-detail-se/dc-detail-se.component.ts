...
@Component({
  selector: 'app-dc-detail-se',
  templateUrl: './dc-detail-se.component.html',
  styles: [
  ]
})
export class DcDetailSeComponent implements OnInit {
  ...
  set data(data) {
    ...
    let isCompany = driverData.isCompany ? driverData.isCompany : false;
