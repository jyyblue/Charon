...
<h1 id="main-header" class="theme-bg-dark theme-text-white">
  ...
  <span ngbDropdown class="d-inline-block">
    <a href="javascript:void(0)" class="theme-text-white" ngbDropdownToggle>Plugins</a>
...
<cui-ngx-textarea-autosize></cui-ngx-textarea-autosize>
...
<cui-ngx-image-cropper></cui-ngx-image-cropper>
<cui-shepherd></cui-shepherd>
