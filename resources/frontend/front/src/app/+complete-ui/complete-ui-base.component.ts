...
<h1 id="main-header" class="theme-bg-dark theme-text-white">
  ...
  <span ngbDropdown class="d-inline-block">
    <a href="javascript:void(0)" class="theme-text-white" ngbDropdownToggle>Base</a>
...
<cui-custom-range-input></cui-custom-range-input>
<cui-forms></cui-forms>
