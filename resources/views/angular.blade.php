...
<head>
    ...
    <link rel="stylesheet" href="/assets/angular/styles.a19e7178be3d1fc3f43e.css">
</head>
...
<body>
    ...
    <div class="app-splash-screen">
        <div class="app-splash-screen-content">
            <div class="ui-w-60">
                <svg class="d-block" viewBox="0 0 148 80" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path transform="translate(-.1)"
                        d="M52.19,22.73l-8.4,22.35L56.51,78.94a5,5,0,0,0,1.64-2.19l7.34-19.2Z" fill="url(#a)"></path>
    ...
    <script src="/assets/angular/runtime.66bab387080e2d2f8e5f.js" defer></script>
